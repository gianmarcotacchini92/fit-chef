...
export function buildSteps(template: Template, items: RecipeItem[], servings: number): RecipeStep[] {
  ...
  switch (template.id) {
    ...
    case "cod-toasted-tartines": {
      const boats = template.id === "cod-lettuce-boats";
      add(boats ? "Tosta il crumble" : "Tosta le tartine", boats
        ? `Taglia finemente al coltello tutti i ${list("pane")}, compresa la crosta, formando un crumble grossolano. Tostalo in padella antiaderente asciutta a fuoco medio-basso per circa 4 minuti, mescolando, finché dorato e asciutto. Conserva tutto in un recipiente pulito, prima di manipolare il pesce crudo. Non occorre pangrattato aggiuntivo: la parte croccante deriva solo dal pane già pesato.`
        : `Affetta tutti i ${list("pane")}, compresa la crosta, a circa 1 cm di spessore. Tosta in padella antiaderente asciutta circa 2 minuti per lato a fuoco medio-basso, senza bruciare. Conserva fette e briciole su un piatto pulito, prima di manipolare il pesce crudo; nessuna quota di pane viene eliminata.`, 4);
      add("Cuoci il merluzzo in sicurezza", `${panStart} Disponi ${list("proteina")} in filetti spessi al massimo 2 cm, in un solo strato, con ${water(40 * servings)}. ${optionalSeasoning} Copri e cuoci dolcemente circa 12-16 minuti: verifica almeno 63 °C al cuore di ogni filetto con il termometro alimentare; se necessario prolunga la cottura. Se il fondo asciuga, aggiungi fino a ${water(30 * servings)} misurati. Solo dopo la verifica trasferisci il pesce su un piatto pulito e sfaldalo con due forchette pulite. Conserva tutto il fondo già cotto nella padella. Per più porzioni usa una padella capiente o lavora in turni, prolungando se necessario.`, 16);
      if (boats) {
        add("Forma le barchette crude", `Separa le foglie più ampie dei ${list("verdure")}, lavate e ben asciugate, e disponile a barchetta sui piatti. Taglia le foglie piccole, le parti rotte e le coste edibili a striscioline: entreranno tutte nel ripieno. Se non ci sono foglie intere, sovrapponile in ciotoline per sostenere il ripieno. La lattuga resta cruda: non metterla nella padella e usa solo utensili puliti, mai quelli del pesce crudo.`, 3);
        add("Farcisci e completa col crumble", `${list("crema", "acidità") ? `Mescola ${list("crema", "acidità")} in una ciotola pulita e incorpora tutto il condimento al pesce sfaldato, fuori dal fuoco.` : "Raccogli il pesce sfaldato in una ciotola pulita, senza altri condimenti."} Unisci tutto il fondo cotto e le striscioline di lattuga; ripartisci l'intero ripieno nelle foglie. Distribuisci tutto il crumble solo all'ultimo momento, senza immergerlo prima nel fondo: è pane tostato, non una panatura del pesce. Servi tutte le barchette e ogni eventuale ripieno abbondante in ${servings} porzioni uguali, anche con coltello e forchetta. Per il meal prep conserva pesce, lattuga e crumble separati e assembla al consumo.`, 2);
      } else {
        add("Appassisci la lattuga nel fondo cotto", `Taglia ${list("verdure")} a striscioline, incluse le coste edibili tagliate più fini. Aggiungi tutta la lattuga alla padella soltanto dopo aver verificato la cottura del pesce a 63 °C e averlo tolto. Mescola nel fondo già cotto per circa 3 minuti, finché le foglie appassiscono; non sono una guarnizione cruda o croccante. Se il fondo è asciutto, usa ${water(15 * servings)} misurati. Non scolare i succhi.`, 3);
        add("Lega il ripieno e farcisci", `Spegni il fuoco e rimetti tutto il pesce sfaldato nella lattuga appassita.${list("crema", "acidità") ? ` Mescola ${list("crema", "acidità")} e incorpora l'intero condimento alla farcitura fuori dal fuoco, senza farlo bollire.` : " Mescola delicatamente in modo che il fondo cotto rivesta tutta la farcitura, senza altri ingredienti."} Distribuisci l'intero ripieno con tutti i succhi sulle fette tostate e recupera sopra tutte le briciole. Forma tartine aperte da mangiare con coltello e forchetta; ripartisci tutto in ${servings} porzioni, senza scartare il ripieno abbondante. Per il meal prep conserva base e farcitura separate e componi al consumo.`, 3);
      }
      break;
    }
    case "seafood-panzanella":
      add("Reidrata il pane senza sprechi", `Spezzetta tutti i ${list("pane")}, compresa la crosta, in bocconi piccoli. Distribuisci sopra ${water(amount("pane") * 0.4)} fredda, mescola e lascia assorbire circa 4 minuti, rivoltando una volta. Il pane deve diventare morbido ma riconoscibile: non strizzarlo e non scolare, così nessuna parte del pane o del liquido misurato viene persa.`, 4);
      add("Prepara il mare già cotto", `Taglia ${list("proteina")}, già cotto, pronto al consumo e pesato sgocciolato senza condimento, in pezzi di circa 1 cm. Non usare un mix crudo o surgelato da cuocere e non lessare nuovamente il prodotto pronto. ${list("crema", "acidità", "spezie", "olio", "sale") ? `Lavora ${list("crema", "acidità", "spezie", "olio", "sale")} in una ciotola e rivesti il mix di mare con tutto il condimento, una sola volta.` : "Mantieni il mix al naturale, senza altri ingredienti."}`, 2);
      add("Assembla la panzanella", `Taglia ${list("verdure")}, lavata e asciugata, a striscioline, incluse le coste edibili. Unisci tutta la lattuga cruda, tutto il mix di mare con il suo eventuale condimento e tutto il pane reidratato; mescola delicatamente perché il pane assorba il condimento senza diventare una pasta. Ripartisci tutto in ${servings} porzioni e servi subito a freddo. Rispetta conservazione e scadenza della confezione: non è prevista una cottura del mare o della lattuga.`, 2);
      break;
    case "seafood-lettuce-cups":
      add("Tosta il pane in due quote", `Dividi tutti i ${list("pane")} in due quote uguali prima della tostatura: ${formatGrams(amount("pane") / 2)} a cubetti di circa 1 cm per il ripieno e ${formatGrams(amount("pane") / 2)} tritati grossolanamente al coltello per il crumble finale. Usa anche la crosta. Tosta entrambe in padella antiaderente asciutta a fuoco medio-basso per circa 5 minuti, mescolando, poi trasferiscile in due ciotole pulite. Lascia perdere il calore mentre prepari il ripieno; non occorrono altro pane o pangrattato.`, 5);
      add("Prepara coppe e ripieno freddo", `Dai ${list("verdure")}, lavata e asciugata, scegli le foglie più ampie per formare coppe. Taglia tutte le foglie piccole o rotte e le coste edibili a striscioline fini per il ripieno; se mancano foglie intere, sovrapponile in ciotoline. Taglia ${list("proteina")}, già cotto, pronto al consumo e pesato sgocciolato senza condimento, in pezzi piccoli. Non usare un mix crudo da cuocere e non scaldare il prodotto pronto nella padella. ${list("crema", "acidità", "spezie", "olio", "sale") ? `Mescola ${list("crema", "acidità", "spezie", "olio", "sale")} e incorpora tutto il condimento al mare e alle striscioline di lattuga.` : "Mescola il mare e le striscioline di lattuga al naturale, senza altri ingredienti."} Aggiungi al ripieno tutti i cubetti di pane tostato ormai non caldo.`, 4);
      add("Riempi e completa", `Distribuisci tutto il ripieno freddo nelle coppe di lattuga cruda e aggiungi tutto il crumble appena prima di servire. Ripartisci foglie, ripieno e pane in ${servings} porzioni uguali; servi anche l'eventuale ripieno abbondante nei piatti, senza eliminarlo. La croccantezza proviene dal pane tostato e dalla lattuga, non da una frittura del mare. Consuma subito rispettando conservazione e scadenza del prodotto già cotto.`, 2);
      break;
